...
<!-- Agregar aquí -->
	 <div class="col-md-23" >  
				   ...
				   <div class="row" style="height: 70px">
						<div class="col-md-6" >
								<input class="form-control" id="id_filtro"  name="filtro" placeholder="Ingrese título o serie" type="text" maxlength="30"/>
						</div>
						<div class="col-md-2" >
						...
						<div class="col-md-2" >
								<input class="form-control" id="id_filtro_anio"  name="filtro" placeholder="Ingrese año" type="number" maxlength="4"/>
						</div>
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_reg_serie" name="serie" placeholder="Ingrese el número de serie" type="text" maxlength="10"/>
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
		                            ...
		                            <div id="stepOne" class="panel-collapse collapse in">
		                                <div class="panel-body">
		                                    ...
		                                    <div class="form-group">
		                                        ...
		                                        <div class="col-lg-3">
													<input class="form-control" id="id_act_serie" name="serie" placeholder="Ingrese el número de serie" type="text" maxlength="10"/>
		                                        </div>
		                                    </div> 
		                                    <div class="form-group">
	...
	$('#id_table').DataTable({
		...
		columns:[
			...
			{data: function(row, type, val, meta){
				var salida = (row.tipo == 0 ? 'Físico':'Digital');
				return salida;
			}},
